...
<html lang="en"><head>
    ...
    <link rel="stylesheet" type="text/css" href="/view/statics/lib/bootstrap/css/bootstrap.css">
    <link rel="stylesheet" href="/view/statics/lib/font-awesome/css/font-awesome.css">

    <script src="/view/statics/lib/jquery-1.11.1.min.js" type="text/javascript"></script>

    <script src="/view/statics/lib/jQuery-Knob/js/jquery.knob.js" type="text/javascript"></script>
    ...
    <link rel="stylesheet" type="text/css" href="/view/statics/stylesheets/theme.css">
    <link rel="stylesheet" type="text/css" href="/view/statics/stylesheets/premium.css">
...
<div class="navbar navbar-default" role="navigation">
    <div class="navbar-header">
        ...
        <a class="" href="index.html"><span class="navbar-brand"><span class="fa fa-paper-plane"></span> 陌陌游戏管理后台</span></a></div>

    <div class="navbar-collapse collapse" style="height: 1px;">
        <ul id="main-menu" class="nav navbar-nav navbar-right">
            <li class="dropdown hidden-xs">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                    <span class="glyphicon glyphicon-user padding-right-small" style="position:relative;top: 3px;"></span> 440896635
